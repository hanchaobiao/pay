...
def pay(request):
    ...
    alipay = AliPay(
        ...
        app_private_key_path=os.path.join(settings.BASE_DIR, "keys/app_private_2048.txt"),
        alipay_public_key_path=os.path.join(settings.BASE_DIR, "keys/alipay_public_2048.txt"),
